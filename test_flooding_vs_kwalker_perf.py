...
try:
	...
	peer1 = pexpect.spawn('./interactive_peer.py localhost 8500 peer1 10', timeout=timeout)
	peer2 = pexpect.spawn('./interactive_peer.py localhost 8501 peer2 10', timeout=timeout)
